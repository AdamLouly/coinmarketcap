...
get.data <- function(x){
  ...
  to.parse$Symbol <- factor(to.parse$Symbol,levels = to.parse$Symbol[order(to.parse$'% 1h')]) # sort by gain value
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    h6("Built by Adam Louly"),
    br(),
    h6("R version 3.4.4 (2018-08-30) 'Someone to Lean On'"),
    br(),
    a("adamlouly3@gmail.com", href="adamlouly3@gmail.com")
